...
do
        ...
        if [ -s /$WORK_DIR/trinity_out_dir/$file/Trinity.fasta ] 
	then
            rm /$WORK_DIR/trinity_out_dir/$file/Trinity.fasta
        fi
	...
	--right $DATA_DIR/$file/*filtered_R2.fastq --SS_lib_type RF --CPU 6
        ...
        if [ ! -d /$WORK_DIR/trinity_out_dir/$file ]
        then
            mkdir /$WORK_DIR/trinity_out_dir/$file
        fi

        cat /$WORK_DIR/trinity_out_dir/Trinity.fasta > /$WORK_DIR/trinity_out_dir/$file/Trinity.fasta
