...
import os
import sys
import subprocess # PHELE: This added for submitting a job to cluster.
from subprocess import check_output # PHELE: This added for submitting a job to cluster. 
import time
...
def createScript(inputFile1, inputFile2, scriptActions, numProcessors, delimiter, offset):
    ...
    # initial script output: action python scriptsOD
    # bowtie2
    scriptOutput_bowtie2 = open(outputDir + "/pipelineScript_bowtie2.py", "w")
    writeHeader(scriptOutput_bowtie2, inputFile1, inputFile2, fileType1, fileType2, outputDir, scriptActions)

    # blat
    scriptOutput_blat = open(outputDir + "/pipelineScript_blat.py", "w")
    writeHeader(scriptOutput_blat, inputFile1, inputFile2, fileType1, fileType2, outputDir, scriptActions)
    
    # blast
    scriptOutput_blast = open(outputDir + "/pipelineScript_blast.py", "w")
    writeHeader(scriptOutput_blast, inputFile1, inputFile2, fileType1, fileType2, outputDir, scriptActions)
    
    # mpiBlast
    global scriptOutput_finish
    scriptOutput_finish = open(outputDir + "/pipelineScript_finish.py", "w")
    writeHeader(scriptOutput_finish, inputFile1, inputFile2, fileType1, fileType2, outputDir, scriptActions)

    global mpiBlast_params
    mpiBlast_params = open(outputDir + "/mpiBlast_parameters", "w")

    # quality
#    scriptOutput_quality = open(outputDir + "/pipelineScript_quality.py", "w")
#    writeHeader(scriptOutput_quality, inputFile1, inputFile2, fileType1, fileType2, outputDir, scriptActions)

    # removeN
#    scriptOutput_removeNs = open(outputDir + "/pipelineScript_removeNs.py", "w")
#    writeHeader(scriptOutput_removeNs, inputFile1, inputFile2, fileType1, fileType2, outputDir, scriptActions)

    # bowtie
#    scriptOutput_bowtie = open(outputDir + "/pipelineScript_bowtie.py", "w")
#    writeHeader(scriptOutput_bowtie, inputFile1, inputFile2, fileType1, fileType2, outputDir, scriptActions)
    
    # lzw
#    scriptOutput_lzw = open(outputDir + "/pipelineScript_lzw.py", "w")
#    writeHeader(scriptOutput_lzw, inputFile1, inputFile2, fileType1, fileType2, outputDir, scriptActions)
    ...
    for line in scriptActions.split("\n"):
        ...
        if pieces[0] == "quality":
            ...
            if not currentFile2:
                currentFile1 = writeSingleQualityFilter(currentFile1, line, scriptOutput_quality, offset)
                ...
                currentFile1, currentFile2 = writeQualityFilter(currentFile1, currentFile2, line, scriptOutput_quality, offset)

        elif pieces[0] == "removeN":
            if currentFile2:
                currentFile1 = writeCombineFiles(currentFile1, currentFile2, scriptOutput_removeNs)
                currentFile2 = currentFileType2 = None
            
            if currentFileType1 == pipelineUtils.FILE_TYPE_FASTQ:
                currentFile1 = writeConvertToFasta(currentFile1, scriptOutput_removeNs)
            ...
            currentFile1 = writeRemoveNs(currentFile1, line, scriptOutput_removeNs)
            ...
            currentFile1, currentFile2 = writeFilterFromBowtie(outputDir, currentFile1, currentFile2, currentFileType1, line,
                                                        numProcessors, scriptOutput_bowtie, delimiter)
            ...
            currentFile1, currentFile2 = writeFilterFromBowtie2(outputDir, currentFile1, currentFile2, currentFileType1, line,
                                                        numProcessors, scriptOutput_bowtie2, delimiter)
            
        elif pieces[0] == "blast":
            if currentFile2:
                currentFile1 = writeCombineFiles(currentFile1, currentFile2, scriptOutput_blast)
                currentFile2 = currentFileType2 = None

            if currentFileType1 == pipelineUtils.FILE_TYPE_FASTQ:
                currentFile1 = writeConvertToFasta(currentFile1, scriptOutput_blast)
                currentFileType1 = pipelineUtils.FILE_TYPE_FASTA
            ...
            currentFile1 = writeFilterFromBlast(outputDir, currentFile1, line, numProcessors, scriptOutput_blast, delimiter)
            

        elif pieces[0] == "blat":
            if currentFile2:
                currentFile1 = writeCombineFiles(currentFile1, currentFile2, scriptOutput_blat)
                currentFile2 = currentFileType2 = None

            if currentFileType1 == pipelineUtils.FILE_TYPE_FASTQ:
                currentFile1 = writeConvertToFasta(currentFile1, scriptOutput_blat)
                currentFileType1 = pipelineUtils.FILE_TYPE_FASTA
            
            if currentFileType1 != pipelineUtils.FILE_TYPE_FASTA:
                raise Exception("Only FASTA and FASTQ files can be blated.  '%s' is a '%s' file." % (currentFile1, currentFileType1))
            
            currentFile1 = writeFilterFromBlat(outputDir, currentFile1, line, numProcessors, scriptOutput_blat, delimiter)
            
        elif pieces[0] == "lzw":
            if currentFile2:
                currentFile1 = writeCombineFiles(currentFile1, currentFile2, scriptOutput_lzw)
                currentFile2 = currentFileType2 = None
            
            if currentFileType1 != pipelineUtils.FILE_TYPE_FASTA:
                raise Exception("Only FASTA files can be filtered for lzw.  '%s' is a '%s' file." % (currentFile1, currentFileType1))
            
            currentFile1 = writeFilterLZW(currentFile1, line, scriptOutput_lzw)
...
def writeFilterFromBlast(outputDir, inputFasta, line, numProcessors, sf, delimiter):
    ...
    maxEval = None
    minBitScore = None
    delimiter = config.DEFAULT_DELIMITER # Original line: "delimiter = '#0/'"
    pairedHits = True
    pairedMisses = False
    useMisses = True
    ...
    if line.split(" ")[1] == "nt":
        ...
        scriptOutput_finish.write(SCRIPT_MPI_BLAST_END % printVars)
        mpi_blast_params = SCRIPT_MPI_BLAST_PARAMS % printVars
        mpiBlast_params.write(mpi_blast_params)
